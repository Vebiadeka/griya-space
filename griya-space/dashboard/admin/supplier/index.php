...
$jumlah_supplier = mysqli_num_rows($result);
...
<head>
    ...
    <title>Data Supplier | Griya Space</title>
...
<main>
    ...
    <section class="page-header">
        ...
        <div class="page-title">
            ...
            <p>
                Kelola data pemasok dan mitra penyedia barang Griya Space.
            </p>
...
<td>
    ...
    ">
        ...
        <a
            href="edit.php?id=<?= (int) $supplier["id_supplier"]; ?>"
            style="
                display:inline-block;
                padding:7px 10px;
                background:#f0f0ee;
